...
_reactAddons2['default'].render(_reactAddons2['default'].createElement(_componentsStandard2['default'], { images: IMAGES }), document.getElementById('example'));

},{"./components/Standard":2,"react/addons":4}],2:[function(require,module,exports){
'use strict';
...
var Standard = _reactAddons2['default'].createClass({
	...
	renderGallery: function renderGallery() {
		...
		var gallery = this.props.images.map(function (url, i) {
			return _reactAddons2['default'].createElement('a', { key: i, href: url, onClick: _this.openLightbox.bind(_this, i), style: _extends({}, styles.thumbnail, { backgroundImage: 'url(' + url + ')' }) });
		});
...
},{"react-images":undefined,"react/addons":4}],3:[function(require,module,exports){
