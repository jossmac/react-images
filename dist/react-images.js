		...
		value: function renderDialog() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'div',
					{ className: (0, _aphroditeNoImportant.css)(classes.content) + ' lightboxContent', style: { marginBottom: offsetThumbnails, maxWidth: width } },
...
function Arrow(_ref, _ref2) {
	...
	return _react2['default'].createElement(
		...
		_extends({
			type: 'button',
			className: (0, _aphroditeNoImportant.css)(classes.arrow, classes['arrow__direction__' + direction], size && classes['arrow__size__' + size]) + ' lightboxArrow',
			onClick: onClick,
			onTouchEnd: onClick
		}, props),
...
var PaginatedThumbnails = (function (_Component) {
	...
	_createClass(PaginatedThumbnails, [{
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				'div',
				{ className: (0, _aphroditeNoImportant.css)(classes.paginatedThumbnails) + ' lightboxPaginated' },
				this.renderArrowPrev(),
