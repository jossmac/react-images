...
var Lightbox = function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		value: function renderImages() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('img', {
					className: (0, _aphrodite.css)(this.classes.image, imageLoaded && !imagesLoading && this.classes.imageLoaded),
		...
		value: function renderSpinner() {
			...
			return _react2.default.createElement(
				'div',
				{ className: (0, _aphrodite.css)(this.classes.spinner, (!imageLoaded || imagesLoading) && this.classes.spinnerActive) },
...
Lightbox.propTypes = {
	...
	images: _propTypes2.default.arrayOf(_propTypes2.default.shape({
		...
		srcfetcher: _propTypes2.default.func,
